...
import Checkoutdata from './component/checkout';
  ...
  return (
    <>
      ...
      <h3 className="total">total ${
        ...
        <button className="btn" onClick={props.checkout}>Checkout</button>
      </div>
    </>)
}
...
class App extends React.Component {
  ...
  render() {
    return (
      <div>
        <Header cart={this.state.cart} handleCart={this.handleCart} handleView={this.handleView} />
        {this.handleSwitch()}
